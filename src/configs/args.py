...
def parse_arguments():
    ...
    parser.add_argument('--data_url', default="./src/data/imagenet", help='Location of data.')
    ...
    # Here! --swin_config required=True
    ...
    # I just delete two parameters: "pretrained" and "run_modelarts"  
